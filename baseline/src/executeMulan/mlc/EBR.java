...
public class EBR extends TransformationBasedMultiLabelLearner {
    ...
    public void setUseConfidences(boolean conf){
    	this.useConfidences = conf;
    }
    ...
    public EBR(boolean useConfidences, int seed){
     ...
     */
    public EBR(Classifier classifier, int aNumOfModels,
